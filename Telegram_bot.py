...
# ===================== НАСТРОЙКИ =====================
TOKEN = os.environ.get('TOKEN', "8677089714:AAEssWzeYxdgx2GiCr9mCtxhmFYMPN7Bc8k")
...
# Telegram API данные из переменных окружения
API_ID = int(os.environ.get('API_ID', 36307326))
API_HASH = os.environ.get('API_HASH', "8c6d09b1fbaf3c9158128558091cb22f")
